define([
  'aeris/util',
  'aeris/interactive/application/forms/controllers/togglecollectioncontroller'
], function(_, ToggleCollectionController) {
  /**
   *
   * @class FilterTogglesController
   * @namespace aeris.interactive.maps.markers.controllers
   * @extends aeris.interactive.application.forms.controllers.ToggleCollectionController
   *
   * @constructor
   * @override
   */
